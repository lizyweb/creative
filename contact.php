...
try {
    ...
    $subject = 'Creative Architecture Construction & Interior Architect Contact Form'; // Define your email subject
    ...
    $mail->addAddress('creativeinteriorarchitect@gmail.com');
